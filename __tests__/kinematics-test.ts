...
describe("Kinematics", () => {
    ...
    describe("closest point of approach", () => {
        test("handles trailing tracks", () => {
            ...
            const px = Geodetics.destination(p1, Angle.ofDegrees(20), Length.ofKilometres(1), earthRadius)
        ...
        test("returns undefined if time to CPA is in the past", () => {
            const t1 = new Track(LatLong.ofDegrees(30, 30), Angle.ofDegrees(45), Speed.ofKnots(400))
            const t2 = new Track(LatLong.ofDegrees(30.01, 29.99), Angle.ofDegrees(315), Speed.ofKnots(400))
